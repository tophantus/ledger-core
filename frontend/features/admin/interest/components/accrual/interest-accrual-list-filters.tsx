...
interface InterestAccrualListFiltersProps {
...
export function InterestAccrualListFilters({
    filters,
    onChange,
}: InterestAccrualListFiltersProps) {
            ...
            {expanded && (
                ...
                ">
                    ...
                    ">
                        <div>
                            <label
                                htmlFor="interest-accrual-run-id"
                                className="
                                    mb-2
                                    block
                                    text-sm
                        ...
                        <div>
                            <label
                                htmlFor="interest-accrual-account-id"
                                className="
                                    mb-2
                                    block
                                    text-sm
                            ...
                            <input
                                id="interest-accrual-account-id"
                                type="text"
                                value={
                                    filters.accountId ??
                                    ""
                        ...
                        <div>
                            <label
                                htmlFor="interest-accrual-business-date"
                                className="
                                    mb-2
                                    block
                                    text-sm
                            ...
                            <input
                                id="interest-accrual-business-date"
                                type="date"
                                value={
                                    filters.businessDate ??
                                    ""
