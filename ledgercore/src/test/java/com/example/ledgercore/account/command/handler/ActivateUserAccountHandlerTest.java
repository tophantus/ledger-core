...
class ActivateUserAccountHandlerTest {
    ...
    private ActivateUserAccountHandler handler;
    ...
    @BeforeEach
    void setUp() {
        handler = new ActivateUserAccountHandler(
    ...
    @Test
    void shouldNotUpdateStatusWhenActivationIsRejected() {
        GetUserAccountResult account = createAccount(
                accountId,
                userId,
                AccountStatus.CLOSED
