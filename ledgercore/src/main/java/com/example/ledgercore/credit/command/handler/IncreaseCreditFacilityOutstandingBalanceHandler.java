...
public class IncreaseCreditFacilityOutstandingBalanceHandler
        implements IncreaseCreditFacilityOutstandingBalanceUseCase {
    ...
    public void execute(
        ...
        if (newOutstandingBalance
                .compareTo(facility.getCreditLimit()) > 0) {
